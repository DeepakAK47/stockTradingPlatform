        ...
        <div className="container p-5">
            <div className="row p-5">
                <div className="col-6 p-5">
                    ...
                    <p className="text-muted">No gimmicks, spam, "gamification", or annoying push notifications. High quality apps that you use at your pace, the way you like.<br></br><a href="" style={{textDecoration : "none"}}>Our philosophies</a></p>
                    ...
                    <p className="text-muted text-muted">With initiatives like <a href="" style={{textDecoration :"none"}}>Nudge</a> and <a href="" style={{textDecoration : "none"}}>Kill Switch</a>, we don't just facilitate transactions, but actively help you do better with your money.</p>
                </div>
                <div className="col-6 p-5">
